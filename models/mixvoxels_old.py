...
class MixVoxels(torch.nn.Module):
    def __init__(self, args, aabb, gridSize, device,
        ...
        self.TimeHead = {'directdyrender': DirectDyRender,
                         'forrier': ForrierDyRender,
                         'auto': AutoSyncDirectDyRender}[time_head]
        ...
        self.n_cameras = 30
        self.time_delta = torch.nn.parameter.Parameter(0*torch.randn(self.n_cameras, device=device))
    ...
    def forward_seperatly(self, rays_chunk, std_train, white_bg=True, is_train=False, ndc_ray=False, N_samples=-1,
                          rgb_train=None, temporal_indices=None, render_path=False, cams_train=None):
